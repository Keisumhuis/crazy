...
namespace crazy {
    ...
    class MVCCWriteTransaction : public Noncopyable {
        friend class MVCCLockWrapper<type_value>;
    public:
        /**
         * @brief 移动构造函数
         */
    ...
    protected:
        /**
         * @brief 私有构造函数，只能由MVCCLockWrapper创建
         * @param wrapper 父MVCCLockWrapper对象的引用
         */
        explicit MVCCWriteTransaction(MVCCLockWrapper<type_value>& wrapper)
            : wrapper_(&wrapper)
    ...
    private:
        MVCCLockWrapper<type_value>* wrapper_;
        int32_t next_idx_;
        bool is_active_;
    };
     ...
     */
    template <typename type_value>
    class MVCCLockWrapper final : public Noncopyable {
    ...
    public:
         ...
         */
        explicit MVCCLockWrapper(const type_value& initial_value = type_value{}) {
